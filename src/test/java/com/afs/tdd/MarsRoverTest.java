...
class MarsRoverTest {
    ...
    @Test
    void should_return_locationX_0_locationY_0_direction_N_when_execute_command_given_locationX_0_locationY_0_direction_W_and_L() {
        //given
        MarsRover marsRover = new MarsRover(new RoverStatus(0, 0, "W"));
        RoverStatus expectedRoverStatus = new RoverStatus(0, 0, "N");
    ...
    @Test
    void should_return_locationX_negative_1_locationY_1_direction_N_when_execute_command_given_locationX_0_locationY_0_direction_N_and_M_R_M_L() {
        //given
        MarsRover marsRover = new MarsRover(new RoverStatus(0, 0, "N"));
